...
array_intersect()	返回两个或多个数组的交集数组	"$a1=array(0=>""Cat"",1=>""Dog"",2=>""Horse"");
$a2=array(3=>""Horse"",4=>""Dog"",5=>""Fish"");
print_r(array_intersect($a1,$a2));
"
数组查找替换：		
array_search()	在数组中查找一个值，返回一个键，没有返回返回假	"$a=array(""a""=>""Dog"",""b""=>""Cat"",""c""=>""Horse"");
...
array_key_exists()	判断某个数组中是否存在指定的 key	"$a=array(""a""=>""Dog"",""b""=>""Cat"");
...
"
数组指针操作:		
key()	返回数组内部指针当前指向元素的键名	"$people = array(""Peter"", ""Joe"", ""Glenn"", ""Cleveland"");
echo ""The key from the current position is: "" . key($people);
"
next()	把指向当前元素的指针移动到下一个元素的位置，并返回当前元素的值	"$people = array(""Peter"", ""Joe"", ""Glenn"", ""Cleveland"");

echo current($people) . ""<br />"";
echo next($people); 
"
prev()	把指向当前元素的指针移动到上一个元素的位置，并返回当前元素的值	"$people = array(""Peter"", ""Joe"", ""Glenn"", ""Cleveland"");

echo current($people) . ""<br />"";
echo next($people) . ""<br />""; 
echo prev($people);"
end()	将数组内部指针指向最后一个元素，并返回该元素的值（如果成功）	"$people = array(""Peter"", ""Joe"", ""Glenn"", ""Cleveland"");

echo current($people) . ""<br />"";
echo end($people); 
"
reset()	把数组的内部指针指向第一个元素，并返回这个元素的值	"$people = array(""Peter"", ""Joe"", ""Glenn"", ""Cleveland"");

echo current($people) . ""<br />"";
echo next($people) . ""<br />"";
echo reset($people);
"
current()	返回数组中的当前元素（单元）。	"$people = array(""Peter"", ""Joe"", ""Glenn"", ""Cleveland"");
...
print_r($a);"
数组键值操作:		
shuffle()	本函数为 array 中的单元赋予新的键名。这将删除原有的键名而不仅是重新排序	"$my_array = array(""a"" => ""Dog"", ""b"" => ""Cat"");
shuffle($my_array);
print_r($my_array);"
...
sort($my_array);
print_r($my_array);"
rsort()	对数组逆向排序,不保留键名	"<?php
$my_array = array(""a"" => ""Dog"", ""b"" => ""Cat"", ""c"" => ""Horse"");
rsort($my_array);
print_r($my_array);
?>
"
asort()	对数组排序,保持索引关系	"$my_array = array(""a"" => ""Dog"", ""b"" => ""Cat"", ""c"" => ""Horse"");

asort($my_array);
print_r($my_array);
"
arsort()	对数组逆向排序,保持索引关系	"$my_array = array(""a"" => ""Dog"", ""b"" => ""Cat"", ""c"" => ""Horse"");

arsort($my_array);
print_r($my_array);
"
ksort()	按键名对数组排序	"$my_array = array(""a"" => ""Dog"", ""b"" => ""Cat"", ""c"" => ""Horse"");
ksort($my_array);
print_r($my_array);
"
krsort()	将数组按照键逆向排序	"$my_array = array(""a"" => ""Dog"", ""b"" => ""Cat"", ""c"" => ""Horse"");
krsort($my_array);
print_r($my_array);
"
natsort()	用自然顺序算法对数组中的元素排序	"$temp_files = array(""temp15.txt"",""temp10.txt"",
