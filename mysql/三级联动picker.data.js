...
//   <select name="sheng" id="sheng" onchange="sheng(this);" >

//       <option value="0">请选择省份</option>

//   </select>

//   <select name="shi" id="shi" onchange="shi(this);">
...
// <script>
//       var i = '<option value="0">请选择省份</option>';
//       $.each(ChineseDistricts['86'], function(k, v){
//           $.each(v, function(kv, vv){
//             i += "<option value='"+ vv['code'] +"'>"+ vv['address'] +"</option>";
//           });
//       });
//               $('#sheng').html(i);
...
//       $.each(ChineseDistricts[$(obj).val()], function(kk, vk){
//             s += "<option value='"+ kk +"'>"+ vk +"</option>";
//       });
//               $('#shi').html(s);
// }
...
// function shi(o){
//    var q = '<option value="0">请选择区</option>';
//       $.each(ChineseDistricts[$(o).val()], function(kc, vc){
//             q += "<option value='"+ kc +"'>"+ vc +"</option>";
//       });
//               $('#qu').html(q);
// }
